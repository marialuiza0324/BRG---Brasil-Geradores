...
Static nPosCFOP   := 0000                                                                  //Posição Inicial da Coluna de CFOP (C6_CF)
...
Static cMaskPrc   := PesqPict("SC6", "C6_PRCVEN")                                          //Máscara de preço
		...
		While ! QRY_PED->(EoF())
			...
			While ! QRY_ITE->(EoF())
				...
				If cLayout == "1"
					...
					oPrintPvt:SayAlign(nLinAtu, nPosDesc, QRY_ITE->B1_DESC,                                  oFontDet, 150, 07, , nPadLeft, )
					oPrintPvt:SayAlign(nLinAtu, nPosCFOP, Alltrim(QRY_ITE->C6_CF),                           oFontDet, 022, 07, , nPadLeft, )
				...
				Else
					...
					oPrintPvt:SayAlign(nLinAtu, nPosDesc, QRY_ITE->B1_DESC,                                  oFontDet, 145, 07, , nPadLeft, )
					oPrintPvt:SayAlign(nLinAtu, nPosUnid, QRY_ITE->C6_UM,                                    oFontDet, 020, 07, , nPadLeft, )
					oPrintPvt:SayAlign(nLinAtu, nPosCFOP, Alltrim(QRY_ITE->C6_CF),                           oFontDet, 025, 07, , nPadLeft, )
					oPrintPvt:SayAlign(nLinAtu, nPosQuan, Alltrim(Transform(QRY_ITE->C6_QTDVEN, cMaskQtd)),  oFontDet, 035, 07, , nPadRight, )
					oPrintPvt:SayAlign(nLinAtu, nPosVUni, Alltrim(Transform(QRY_ITE->C6_PRCVEN, cMaskPrc)),  oFontDet, 048, 07, , nPadRight, )
					oPrintPvt:SayAlign(nLinAtu, nPosVTot, Alltrim(Transform(QRY_ITE->C6_VALOR, cMaskVlr)),   oFontDet, 055, 07, , nPadRight, )
					oPrintPvt:SayAlign(nLinAtu, nPosBIcm, Alltrim(Transform(nBasICM, cMaskPad)),             oFontDet, 040, 07, , nPadRight, )
					oPrintPvt:SayAlign(nLinAtu, nPosVIcm, Alltrim(Transform(nValICM, cMaskPad)),             oFontDet, 035, 07, , nPadRight, )
					oPrintPvt:SayAlign(nLinAtu, nPosVIPI, Alltrim(Transform(nValIPI, cMaskPad)),             oFontDet, 025, 07, , nPadRight, )
					oPrintPvt:SayAlign(nLinAtu, nPosAIcm, Alltrim(Transform(nAlqICM, cMaskPad)),             oFontDet, 025, 07, , nPadRight, )
					oPrintPvt:SayAlign(nLinAtu, nPosAIpi, Alltrim(Transform(nAlqIPI, cMaskPad)),             oFontDet, 028, 07, , nPadRight, )
				EndIf
				nLinAtu += 7
...
Static Function fImpCab()
	...
	If cLayout == "1"
		...
		oPrintPvt:SayAlign(nLinCab, nPosDesc, "Descrição", oFontDetN, 150, 07, , nPadLeft, )
		oPrintPvt:SayAlign(nLinCab, nPosCFOP, "CFOP",      oFontDetN, 022, 07, , nPadLeft, )
	...
	Else
		...
		oPrintPvt:SayAlign(nLinCab, nPosDesc, "Descrição", oFontDetN, 145, 07, , nPadLeft, )
		oPrintPvt:SayAlign(nLinCab, nPosUnid, "UM",        oFontDetN, 020, 07, , nPadLeft, )
		oPrintPvt:SayAlign(nLinCab, nPosCFOP, "CFOP",      oFontDetN, 025, 07, , nPadLeft, )
		oPrintPvt:SayAlign(nLinCab, nPosQuan, "Quant.",    oFontDetN, 035, 07, , nPadRight, )
		oPrintPvt:SayAlign(nLinCab, nPosVUni, "Vl.Unit.",  oFontDetN, 048, 07, , nPadRight, )
		oPrintPvt:SayAlign(nLinCab, nPosVTot, "Vl.Total",  oFontDetN, 055, 07, , nPadRight, )
		oPrintPvt:SayAlign(nLinCab, nPosBIcm, "BC.ICMS",   oFontDetN, 040, 07, , nPadRight, )
		oPrintPvt:SayAlign(nLinCab, nPosVIcm, "Vl.ICMS",   oFontDetN, 035, 07, , nPadRight, )
		oPrintPvt:SayAlign(nLinCab, nPosVIPI, "Vl.IPI",    oFontDetN, 025, 07, , nPadRight, )
		oPrintPvt:SayAlign(nLinCab, nPosAIcm, "A.ICMS",    oFontDetN, 025, 07, , nPadRight, )
		oPrintPvt:SayAlign(nLinCab, nPosAIpi, "A.IPI",     oFontDetN, 028, 07, , nPadRight, )
	EndIf
...
Static Function fMudaLayout()
	...
	If cLayout == "1"
		...
		nPosDesc := 0045 //Descrição
		nPosCFOP := 0220 //CFOP (C6_CF)
		nPosQuan := 0245 //Quantidade
		nPosVUni := 0270 //Valor Unitario
		nPosSTUn := 0295 //Valor Unitário ST
		nPosSTVl := 0320 //Valor Unitário + ST
	...
	Else
		...
		nPosUnid := 0197 //Unidade de Medida
		nPosCFOP := 0218 //CFOP (C6_CF)
		nPosQuan := 0245 //Quantidade
		nPosVUni := 0282 //Valor Unitario
		nPosVTot := 0332 //Valor Total
		nPosBIcm := 0389 //Base Calculo ICMS
		nPosVIcm := 0431 //Valor ICMS
		nPosVIPI := 0468 //Valor Ipi
		nPosAIcm := 0495 //Aliquota ICMS
		nPosAIpi := 0522 //Aliquota IPI
...
Static Function fMontDupl()
	...
	If lDtEmi
		...
		If (SE4->E4_TIPO != "9")
			...
			aDupl := Condicao(MaFisRet(, "NF_BASEDUP"), SC5->C5_CONDPAG, MaFisRet(, "NF_VALIPI"), Date(), MaFisRet(, "NF_VALSOL"))
