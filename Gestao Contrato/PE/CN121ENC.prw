...
Possibilita ao desenvolvedor realizar operações 
após o encerramento da medição.
Executado uma vez ao fim do encerramento ainda dentro 
da transação e mais uma vez após o fim da transação..
Utilizado para incluir título financeiro na tabela SE2
@type  Function
@author Maria Luiza
@since 25/07/2024*/
