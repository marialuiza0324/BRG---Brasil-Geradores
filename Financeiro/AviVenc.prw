...
ฑฑบDescricao ณ Relatorio Titulos Vencidos (email)                         บฑฑ
...
User Function AviVenc //U_AviVenc()

Private cPerg       := PADR("AviVenc",Len(SX1->X1_GRUPO))
...
cTitulo := "Relatorio Aviso de tํtulos vencidos"

oReport  := TReport():New("AviVenc",cTitulo,"AviVenc",{|oReport| PrintReport1(oReport)},cTitulo)
...
oSection := TRSection():New(oReport,"Relatorio Aviso de tํtulos vencidos",{""})
...
TRCell():New(oSection, "CEL06_CLIENTE"        , "SE1", "Cliente"   		     ,PesqPict("SE1","E1_CLIENTE"  ),14	  			     , /*lPixel*/, /* Formula*/)
