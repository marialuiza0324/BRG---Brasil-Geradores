...
//aAdd(aBMP,"\system\itau.bmp")
	...
	While SE1->(!EOF())
		...
		If Marked("E1_OK")//aMarked[i]
			...
			_nVlrAbat   +=  SE1->E1_DECRESC + SE1->E1_INSS + SE1->E1_CSLL + SE1->E1_COFINS + SE1->E1_PIS +_ImpRet + nVlrIss  //E1_VALLIQ //SomaAbat(SE1->E1_PREFIXO,SE1->E1_NUM,SE1->E1_PARCELA,"R",1,,SE1->E1_CLIENTE,SE1->E1_LOJA)
